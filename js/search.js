...
function renderPage(page, filteredSets) {
  ...
  document.querySelectorAll(".regularbooking").forEach((btn) => {
    btn.addEventListener("click", function (e) {
      e.preventDefault();
      console.log({
        type: this.getAttribute("data-type"),
        aircraft_unique_id: this.getAttribute("data-aircraft-id"),
        flightRequestId: this.getAttribute("data-flight-request-id"),
...
<a  class="regularbooking button fill_button request-book-btn" href="#" data-price="${calculateTotal}" data-flight-request-id="${flightRequestId}" data-type="market" data-aircraft-id="${
    item._id
  }">REQUEST TO BOOK</a>
